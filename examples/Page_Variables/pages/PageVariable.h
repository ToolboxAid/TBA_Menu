...
class PageVariable : public ElementPage
{
private:
...
public:
  ...
  {
    // Add labels
    this->addLabel(new ElementLabel(chrVarName, new Point(75, 60)));
  ...
  {
    // Add labels
    this->addLabel(new ElementLabel(intVarName, new Point(75, 80)));
    // Add INT variable
  ...
  {
    // Add labels
    this->addLabel(new ElementLabel(fltVarName, new Point(75, 100)));
  ...
  { // float - stores floating point numbers, with decimals, such as 19.99 or -19.99
    ElementVariable *element = getPageVariable(fltVarName);
  ...
  {
    // Add labels
    this->addLabel(new ElementLabel(dblVarName, new Point(75, 120)));
  ...
  { // double - stores floating point numbers, with decimals, such as 19.99 or -19.99
    ElementVariable *element = getPageVariable(dblVarName);
  ...
  {
    // Add labels
    this->addLabel(new ElementLabel(strVarName, new Point(75, 140)));
  ...
  {                        // string - stores text, such as "Hello", "World". String values are surrounded by double quotes
    ElementVariable *element = getPageVariable(strVarName);
    //                                   1         2
  ...
  {
    // Add labels
    this->addLabel(new ElementLabel(bolVarName, new Point(75, 160)));
  ...
  PageVariable() : ElementPage(PageVariable::NAME, 1, true, true, 200, PageVariable::MAIN)
  {
    chrAdd();
    intAdd();
    fltAdd();
    ...
    this->addButton(new ElementButton(PageVariable::MAIN, new Dimensions(120, 200, 60, 25), PageVariable::MAIN));
  }
